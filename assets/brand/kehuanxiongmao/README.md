...
- 品牌素材可以进入 Catalog，但不得替代网站主页、功能入口、参数页、因果流程或真实结果图。
- 当前 Planner 不使用品牌 IP 作为缺图兜底；缺少匹配素材时使用 `light_sweep_fallback`。
- 只有文案明确要求品牌、IP 或 CTA，且 ActionScene 已绑定对应素材时，才使用本目录媒体。
