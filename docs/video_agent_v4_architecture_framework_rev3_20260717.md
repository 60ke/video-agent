...
1. `VideoScope` 与 `SceneSemanticPlan` Contract（含 `sequence` 结构与依赖图字段）；已进入 `video_agent_v4_stage1_semantic_contract_and_ai_runtime_design_20260717.md`；
2. Scope 和 Scene Semantics Prompt；已进入同一 Stage 1 正式设计；
